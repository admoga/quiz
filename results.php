...
<div class="results">
    <p id="firstSentence"><b><?php echo $score?><span style="color: hotpink"> <?php echo $tranlations[$lang]["correct answers of"]?> </span>10<span style="color: hotpink"> <?php echo $tranlations[$lang]["questions"]?> </span></b></p>
    ...
    <div align="center">
        <a href="quiz.php?lang=<?php echo $lang ?>" id="btn"><?php echo $tranlations[$lang]["try again"];?></a>
        <a href="start.php?lang=<?php echo $lang ?>" id="btn"><?php echo $tranlations[$lang]["exit"];?></a>
    </div>
</div>
